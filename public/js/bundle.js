...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWpzdHlsZTQ1IiwiYSI6ImNrODQ2NXAxMzAxcnYzbXQ0aHBldWpwb3MifQ.RDIrPEKych0EhXcV3dZrjg';
  ...
  var bounds = new mapboxgl.LngLatBounds(); //createMarker
  ...
  new mapboxgl.Marker({
    element: el,
    anchor: 'bottom'
  }).setLngLat(locations.coordinates).addTo(map); //Add Popup

  new mapboxgl.Popup({
    offset: 30
  }).setLngLat(locations.coordinates).setHTML("<p>".concat(locations.description, "</p>")).addTo(map); //Extend the map bound to include the location
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Created New Account Successfully!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"passwordOps.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (result.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Recovery link has sent to your registered email!');
              window.setTimeout(function () {
...
var stripe = Stripe('pk_test_yAvpPPSrN75PT7G8l6mM2VU5002XZosmpz');
...
var _passwordOps = require("./passwordOps");
...
if (document.querySelector('.form--password-recover')) {
  document.querySelector('.form--password-recover').addEventListener('submit', function (e) {
    (0, _alerts.showAlert)('processing', 'This Feature is Under construction!');
  });
} //!Forgot Paasword


if (document.querySelector('.form--forgotPassword')) {
  document.querySelector('.form--forgotPassword').addEventListener('submit', function (e) {
    e.preventDefault();
    (0, _alerts.showAlert)('processing', 'Processing...');
    var email = document.getElementById('email').value;
    (0, _passwordOps.forgotPassword)(email);
  });
} //! Signup
...
if (document.querySelector('.form--signup')) {
  document.querySelector('.form--signup').addEventListener('submit', function (e) {
    e.preventDefault();
    (0, _alerts.showAlert)('processing', 'Signing Up! Please Wait...');
...
var bookBtn = document.getElementById('book-product'); //!For map on the product page
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    e.preventDefault();
    (0, _alerts.showAlert)('processing', 'Logging In! Please wait...');
    var email = document.getElementById('email').value;
    var password = document.getElementById('password').value;
...
logOutBtn.addEventListener('click', _login.logout); //!Update User data like name and email
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  (0, _updateSettings.updateSettings)(form, 'data'); // document.querySelector('.btn--save-data').textContent = 'Save settings';
